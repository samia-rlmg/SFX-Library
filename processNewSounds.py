...
def renameTracks(origFolder):
    ...
    folder = re.split("\W", origFolder)[0] # Pull the CD number out of the folder name
    lib = re.split(" - ", origFolder)[-1] # Pull the library name out of the folder name
